...
formulario.addEventListener('submit', (e)=>{
    ...
    if(fechaFinal>fechaInicial){
        ...
        respuesta.innerHTML=`<p>La diferencia es de ${diasTranscurridos} día(s).</p>
                             <p>La diferencia es de ${diasTranscurridos/30} mes(es).*</p>
                             <p>La diferencia es de ${diasTranscurridos/365} año(s).**</p>`
    }else{
        respuesta.innerHTML=':('
